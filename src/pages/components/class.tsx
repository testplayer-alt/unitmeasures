...
export default function Class({ classname, tag, onSubjectChange }: Props) {
    const classlist = {
        ...
        "月曜2限": ["空きコマ", "データベース(C)", "ビジネス英語実習1b(B)", "ビジネス入門(D)", "ビジネス入門(E)", "マーケティング基礎(C)", "スタディスキル(A)"],
        "月曜3限": ["空きコマ", "イノベーションの志(E)", "ビジネス入門(A)", "マーケティング基礎(B)", "プログラミング基礎実習(D)", "スタディスキル(C)"],
        "月曜4限": ["空きコマ", "イノベーションの志(A)"],
        "月曜5限": ["空きコマ", "ビジネス英語実習1a(Advanced)", "eスポーツ"],
        "月曜6限": [],
        "火曜1限": ["空きコマ", "ビジネス英語実習1a(D)", "マーケティング基礎(E)", "プログラミング基礎実習(B)"],
        "火曜2限": ["空きコマ", "データベース(D)", "ビジネス英語実習1a(C)", "英語コア・スキルズ1(D)", "マネジメント(E)", "マーケティング基礎(A)"],
        "火曜3限": ["空きコマ", "データベース(B)", "ビジネス英語実習1a(A)", "デザイン入門", "マネジメント(B)", "イノベーション特講(石戸)"],
        "火曜4限": ["空きコマ", "データ構造と処理法", "ビジネス英語実習1b(Advanced)"],
        "火曜5限": ["空きコマ", "情報系数学応用A"],
        "火曜6限": [],
        "水曜1限": ["マネジメント(A)", "プログラミング基礎実習(C)"],
        "水曜2限": ["空きコマ", "ビジネス英語実習1a(E)", "英語コア・スキルズ1(B)", "マネジメント(D)"],
        "水曜3限": ["空きコマ", "ICT入門"],
        ...
        "金曜2限": ["空きコマ", "ビジネス英語実習1b(D)", "英語コア・スキルズ(C)", "スタディスキル(E)"],
        "金曜3限": ["空きコマ", "イノベーションの志(C)", "英語コア・スキルズ1(A)", "プログラミング基礎実習(E)", "スタディスキル(B)"],
        "金曜4限": ["空きコマ", "イノベーションの志(B)", "スタディスキル(D)"],
        "金曜5限": ["空きコマ", "eスポーツ"],
        "金曜6限": [],
    };
